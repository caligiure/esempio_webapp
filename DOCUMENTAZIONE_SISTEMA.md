...
Poiché l'ambiente non permetteva l'esecuzione automatica, segui questa guida per avviare e verificare la tua applicazione.
...
2. Avvio del Backend
Apri un terminale in c:\antigravity\esempio_webapp\backend.
Esegui il comando:
mvn spring-boot:run
...
Segui le istruzioni in c:\antigravity\esempio_webapp\frontend-sources\README.md per creare il progetto e copiare i file.
